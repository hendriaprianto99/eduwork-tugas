...
--
-- Host: localhost
-- Generation Time: Apr 12, 2022 at 09:08 AM
...
CREATE TABLE `pembayaran` (
  ...
  `tanggal_pembayar` date NOT NULL,
  `total_pembayar` int(11) NOT NULL,
...
CREATE TABLE `pembeli` (
  ...
  `jk` char(1) NOT NULL,
  `no_telp_pembeli` char(13) NOT NULL,
...
CREATE TABLE `supplier` (
  ...
  `no_telp_supplier` char(13) NOT NULL,
...
ALTER TABLE `transaksi`
  ...
  ADD KEY `fk_pembeli` (`id_barang`,`id_pembeli`),
...
--
ALTER TABLE `pembayaran`
  MODIFY `id_pembayar` int(11) NOT NULL AUTO_INCREMENT;
